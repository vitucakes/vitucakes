...
export default function InsumosPage({ insumos, setInsumos, recetas = [], onActualizarPrecios, onRevisarStock }) {
  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <div className="flex-1 px-4 py-4 space-y-3">
        {canEdit && onRevisarStock && !search && (
          <button
            onClick={onRevisarStock}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-bold text-blue-900">Revisar stock</p>
              <p className="text-xs text-blue-700">Contá y ajustá el stock de todos los insumos de una.</p>
            </div>
