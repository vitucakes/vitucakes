...
// (no es un movimiento): pisa el valor. Entre reconteos, el stock se mueve solo
// con Compras (suman) y Ventas (restan).
export default function RevisarStockPage({ insumos, setInsumos, onBack }) {
    ...
    <div className="flex flex-col min-h-full bg-brand-50">
      ...
      <div className="bg-white px-5 pt-14 pb-4 sticky top-0 z-10 shadow-sm">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-xl font-bold text-gray-800 flex-1">Revisar stock</h1>
          <LockToggle />
        </div>
        <input
          type="text"
      ...
      <div className="px-4 pt-4">
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-3">
          <p className="text-xs text-blue-800 leading-relaxed">
            Contá lo que tenés hoy de cada insumo y corregí lo que no coincida (en su unidad). Lo que
            escribas pisa el stock actual. Dejá igual lo que ya esté bien; entre reconteos se ajusta solo con
            Compras y Ventas.
          </p>
        </div>
      </div>
